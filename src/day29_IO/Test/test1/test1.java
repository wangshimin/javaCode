...
public class test1 {
    public static void main(String[] args) throws IOException {
        ...
        */
        ...
        //6.写出数据
        BufferedWriter bw = new BufferedWriter(new FileWriter("myfile/io_test1.txt"));
        for (String str : list) {
            bw.write(str);
            bw.newLine();
        }
    ...
    public static String webCrawler(String net) throws IOException {
        ...
        // 4.读取数据
        InputStreamReader isr = new InputStreamReader(conn.getInputStream()); // 使用转换流，字节流变成字符流
        int ch;
        while ((ch = isr.read()) != -1){
            sb.append((char)ch);
        }
